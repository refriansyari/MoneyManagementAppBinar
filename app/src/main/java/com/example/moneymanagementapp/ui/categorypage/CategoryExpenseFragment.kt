...
class CategoryExpenseFragment :
    BaseFragment<FragmentCategoryExpenseBinding, CategoryListViewModel>(FragmentCategoryExpenseBinding::inflate),
    ...
    override fun setupRecyclerView() {
        ...
        getViewBinding().rvCategories.apply {
            ...
            adapter = this@CategoryExpenseFragment.adapter
        }
    }
